...
class _SelectCharacter(FrameBase):
    def __init__(self, game_control, players, token_to_characters, after_sel):
    ...
    def destructed(self):
        for p in self.players:
            self.game_control.select_character(p, self.selected[p.token])
        self.after_selected()
